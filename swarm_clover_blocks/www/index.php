...
<body data-tab="blocks">
	<ul id="tabs" style="padding-bottom: 5px; padding-top: 5px; padding-left: 20px;">
		<a href="http://www.semear.eesc.usp.br/wordpress/" style="text-align:left" target=_blank; rel=noopener noreferrer>
	...
	<div class="popup">
		...
		<form class="content-modal">
			...
			<div class="field">
				...
				<input type="number" id="txt" onkeyup="rage_enforced()" min="0" max="20" stpe="1">
	...
	<xml xmlns="https://developers.google.com/blockly/xml" id="toolbox" style="display: none">
		...
		<category name="Swarm" colour="#cf0173">
			...
			<block type="set_2d_formation"></block>
			<block type="set_3d_formation"></block>
			<block type="translate_formation"></block>
			<block type="rotate_formation"></block>
			<block type="scale_formation"></block>
